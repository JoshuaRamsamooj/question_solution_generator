# dc motor separately excited - shunt
...
def dcmotor3(difficulty_level):
    ...
    # Equations
    e0 = ([I_IN, I_f, I_a], Eq(I_IN, I_f+I_a), 'e0')
    e1 = ([V_t, I_f, R_f], Eq(V_t, I_f*R_f), 'e1')
    e2 = ([V_t, I_a, R_a, E_a], Eq(V_t, (I_a*R_a) + E_a), 'e2')
    e3 = ([E_a, phi, N, z, P, a], Eq(E_a, (phi*N*z*P)/(60*a)), 'e3')
    e4 = ([E_a, I_a, T_e, omega_m], Eq(E_a, (T_e*omega_m)/I_a), 'e4')
    e5 = ([T_e, K_a, phi, I_a], Eq(T_e, K_a*phi*I_a), 'e5')
    e6 = ([E_a, K_a, phi, omega_m], Eq(E_a, K_a*phi*omega_m), 'e6')
    e7 = ([K_a, z, P, a], Eq(K_a, (z*P)/(2*pi*a)), 'e7')
    e8 = ([omega_m, N], Eq(omega_m, (2*pi*N)/60), 'e8')
    e9 = ([eff, P_output, P_losses], Eq(eff, (P_output/(P_output+P_losses))*100), 'e9')

    e10 = ([P_losses, I_a, R_a, I_f, R_f, P_fw]
           , Eq(P_losses, ((I_a**2)*R_a)+((I_f**2)*R_f)+P_fw), 'e10')

    e11 = ([P_losses, I_a, R_a, V_t, I_f, P_fw]
           , Eq(P_losses, ((I_a**2)*R_a)+(V_t*I_f)+P_fw), 'e11')

    e12 = ([P_losses, I_a, R_a, V_t, R_f, P_fw]
           , Eq(P_losses, ((I_a**2)*R_a)+((V_t**2)/R_f)+P_fw), 'e12')

    e13 = ([P_output, E_a, I_a, P_fw], Eq(P_output, (E_a*I_a)-P_fw), 'e13')
    e14 = ([P_output, T_e, omega_m, P_fw], Eq(P_output, (T_e*omega_m)-P_fw), 'e14')
    e15 = ([T_shaft, P_output, omega_m], Eq(T_shaft, P_output/omega_m), 'e15')
    e16 = ([I_path, I_a, a], Eq(I_path, I_a/a), 'e16')

    list_of_equations = [e0, e1, e2, e3, e4, e5, e6, e7, e8, e9, e10,
                         e11, e12, e13, e14, e15, e16]

    dict_of_equations = {'e0': e0, 'e1': e1, 'e2': e2, 'e3': e3, 'e4': e4, 'e5': e5,
                         'e6': e6, 'e7': e7, 'e8': e8, 'e9': e9,
                         'e10': e10, 'e11': e11, 'e12': e12, 'e13': e13,
                         'e14': e14,  'e15': e15, 'e16': e16}
    #
    list_of_variables = [I_IN, I_f, R_f, V_t, E_a, I_a, R_a, N, phi, z, P
    ...
    dict_of_var_names = {I_IN: 'Input Current',
                         I_f: 'Field Current',
    ...
    dict_of_values1 = {
                     I_IN: nm.round(uniform(101, 102), decimals=2),
                     I_f: nm.round(uniform(1.82, 1.88), decimals=2),
                     R_f: randint(134, 136),
                     V_t: randint(248, 252),
                     E_a: randint(231, 233),
                     I_a: randint(98, 101),
                     R_a: nm.round(uniform(0.2, 0.17), decimals=2),
                     N: sample([1150], 1)[0],
                     ...
                     K_a: randint(191, 193),
                     T_e: randint(191, 193),
                     T_shaft: randint(184, 186),
                     omega_m: nm.round(uniform(120, 121), decimals=2),
                     eff: randint(87, 89),
                     P_losses: randint(3000, 3100),
                     P_output: sample([22380], 1)[0],
                     P_fw: randint(815, 825),
                     I_path: 0.25*randint(98, 101)
                     }
    ...
    dict_of_values2 = {
                     ...
                     P_output: sample([22380], 1)[0],
                     P_fw: randint(815, 825),
                     I_path: 0.5*randint(98, 101)
                     }

    # dict_of_values2 = {
    #                  I_IN: randint(101, 103),
    #                  I_f: nm.round(uniform(1.8, 1.9), decimals=2),
    #                  # R_f: 135,
    #                  R_f: randint(130, 140),
    #                  V_t: randint(245, 255),
    #                  E_a: randint(230, 235),
    #                  I_a: randint(95, 100),
    #                  R_a: nm.round(uniform(0.2, 0.16), decimals=2),
    #                  N: sample([1125, 1150, 1200], 1)[0],
    #                  phi: nm.round(uniform(0.005, 0.0055), decimals=4),
    #                  z: sample([1125, 1150, 1200], 1)[0],
    #                  P: 4,
    #                  a: 2,
    #                  K_a: randint(380, 390),
    #                  T_e: randint(190, 195),
    #                  T_shaft: randint(180, 190),
    #                  omega_m: nm.round(uniform(120, 125), decimals=2),
    #                  eff: randint(88, 92),
    #                  P_losses: randint(2900, 3100),
    #                  P_output: sample([22380, 22000, 21500], 1)[0],
    #                  P_fw: randint(800, 850),
    #                  I_path: 0.5*randint(95, 100)
    #                  }
    ...
    print("For a Shunt DC Motor operating at full load, you are given the following parameters: ")
    ...
    # question
    # =========
    question_html = '<img  class="img-responsive center-block" src="/static/img/dcmotor3.svg" /><br>'

    question_html += '<p>A Shunt ' \
