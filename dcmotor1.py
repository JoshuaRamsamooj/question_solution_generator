...
def dcmotor1(difficulty_level):
    ...
    # Equations
    e1 = ([V_f, I_f, R_f], Eq(V_f, I_f*R_f), 'e1')
    ...
    e11 = ([P_losses, I_a, R_a, V_f, I_f, P_fw]
           , Eq(P_losses, ((I_a**2)*R_a)+(V_f*I_f)+P_fw), 'e11')

    e12 = ([P_losses, I_a, R_a, V_f, R_f, P_fw]
           , Eq(P_losses, ((I_a**2)*R_a)+((V_f**2)/R_f)+P_fw), 'e12')
    ...
    for equation in list_of_equations:
        ...
        # if the amount of unknowns is the same as the amount of variables
    ...
    # question
    # =========
    question_html = '<img  class="img-responsive center-block" src="/static/img/dcmotor1.svg" /><br>'

    question_html += '<p>A Separately Excited ' \
