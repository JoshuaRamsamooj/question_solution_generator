...
def dcgenerator1(difficulty_level):
    ...
    e5 = ([P_load, V_t, I_a], Eq(P_load, V_t*I_a), 'e5')
    e6 = ([P_load, E_a, I_a, R_a], Eq(P_load, (E_a*I_a)-((I_a**2)*R_a)), 'e6')
    ...
    list_of_equations = [e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13]
    ...
    # question
    # =========
    question_html = '<img  class="img-responsive center-block" src="/static/img/dcgenerator1.svg" /><br>'
