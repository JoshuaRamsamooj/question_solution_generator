# dc generator self excited series

from random import *
from sympy import *
import numpy as nm

def dcgenerator2(difficulty_level):
    ...
    # Equations
    e1 = ([E_a, I_a, R_a, V_t, R_f], Eq(E_a, (I_a*(R_a+R_f)) + V_t), 'e1')
    e2 = ([E_a, phi, N, z, P, a], Eq(E_a, (phi*N*z*P)/(60*a)), 'e2')
    e3 = ([P_generated, E_a, I_a], Eq(P_generated, E_a*I_a), 'e3')
    e4 = ([P_load, V_t, I_a], Eq(P_load, V_t*I_a), 'e4')
    e5 = ([P_load, E_a, I_a, R_a, R_f], Eq(P_load, (E_a*I_a)-((I_a**2)*(R_a+R_f))), 'e5')
    e6 = ([eff, P_generated, P_load], Eq(eff, (P_load/P_generated)*100), 'e6')
    e7 = ([T_e, P_generated, omega_m], Eq(T_e, (P_generated/omega_m)), 'e7')
    e8 = ([omega_m, N], Eq(omega_m, (2*pi*N)/60), 'e8')
    e9 = ([E_a, I_a, T_e, omega_m], Eq(E_a, (T_e*omega_m)/I_a), 'e9')
    e10 = ([T_e, K_a, phi, I_a], Eq(T_e, K_a*phi*I_a), 'e10')
    e11 = ([E_a, K_a, phi, omega_m], Eq(E_a, K_a*phi*omega_m), 'e11')
    e12 = ([K_a, z, P, a], Eq(K_a, (z*P)/(2*pi*a)), 'e12')

    list_of_equations = [e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12]
    ...
    dict_of_values1 = {
                     ...
                     eff: randint(91, 92),
                     P_load: randint(11300, 11800),
                     P_generated: randint(12300, 12800),
                     }
    ...
    # question
    # =========
    question_html = '<img  class="img-responsive center-block" src="/static/img/dcgenerator2.svg" /><br>'
